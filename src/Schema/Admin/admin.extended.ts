...
import { EStatus, IAdmin, IAdminUpdateFrom } from "./admin.type";
import { MakeValidator } from "../../Util";


export async function encryptPassword(this: IAdmin, password?: string): Promise<String> {
...
export async function checkPassword(this: IAdmin, password: string): Promise<boolean> {
...
export async function removeByID(this: mongoose.Model<IAdmin>, _id: string): Promise<void> {
    try {
...
export async function update(this: mongoose.Model<IAdmin>, _id: string, newUser: IAdminUpdateFrom, populatePath?: string | string[]): Promise<IAdmin | null> {
...
export async function setStatus(this: mongoose.Model<IAdmin>, _id: string, status: EStatus): Promise<IAdmin | null> {
