...
export async function getUserByEmail(this: mongoose.Model<IUser>, email: string): Promise<IUser> {
...
export async function getUserById(this: mongoose.Model<IUser>, _id: string): Promise<IUser> {
    try {
